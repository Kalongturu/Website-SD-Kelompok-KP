...
<style>
    ...
    .galeri-admin-item:hover { box-shadow: 0 6px 20px rgba(0,43,91,.12); }
    ...
    .galeri-admin-body { padding: .75rem; }
    ...
    .galeri-admin-actions { display: flex; gap: .35rem; margin-top: .5rem; }
</style>
@endsection
            ...
            @foreach ($galeri as $item)
                <div class="galeri-admin-item">
                    ...
                    <div class="galeri-admin-body">
                        ...
                        @if ($item->kategori)
                            <span style="font-size:.7rem;color:var(--primary);background:var(--accent-soft);
